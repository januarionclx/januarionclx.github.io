...
const openFolder = async (event) => {
  ...
  window.innerHTML = `
    <div class="absolute text-white border-2 border-white bg-black" style="width: min(600px, 75%); height: auto;">
      <div class="w-full inline-flex justify-between p-4 border-2 border-white">
        <h2 class="text-lg">${file.title ? file.title : file.name}</h2>
